...
// source: kazchain/kazchain/article.proto
...
func (*Article) Descriptor() ([]byte, []int) {
	return fileDescriptor_b1cc3f8540fa370d, []int{0}
}
...
func (m *Article) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func (m *Article) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Article)(nil), "kazchain.kazchain.Article")
}

func init() { proto.RegisterFile("kazchain/kazchain/article.proto", fileDescriptor_b1cc3f8540fa370d) }

var fileDescriptor_b1cc3f8540fa370d = []byte{
	// 173 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcf, 0x4e, 0xac, 0x4a,
	0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x87, 0x33, 0x12, 0x8b, 0x4a, 0x32, 0x93, 0x73, 0x52, 0xf5, 0x0a,
	0x8a, 0xf2, 0x4b, 0xf2, 0x85, 0x04, 0x61, 0xe2, 0x7a, 0x30, 0x86, 0x52, 0x2c, 0x17, 0xbb, 0x23,
	0x44, 0x8d, 0x10, 0x1f, 0x17, 0x53, 0x66, 0x8a, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0x4b, 0x10, 0x53,
	0x66, 0x8a, 0x90, 0x10, 0x17, 0x4b, 0x5e, 0x62, 0x6e, 0xaa, 0x04, 0x93, 0x02, 0xa3, 0x06, 0x67,
	0x10, 0x98, 0x2d, 0x24, 0xc2, 0xc5, 0x5a, 0x96, 0x98, 0x53, 0x9a, 0x2a, 0xc1, 0x0c, 0x16, 0x84,
	...
	0xdd, 0x58, 0x81, 0x70, 0x6e, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0xd8, 0xb5, 0xc6, 0x80,
	0x00, 0x00, 0x00, 0xff, 0xff, 0xd5, 0xb1, 0x83, 0x76, 0xd0, 0x00, 0x00, 0x00,
}
...
func (m *Article) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintArticle(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintArticle(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
